    ...
    <div class="container">
        <div class="row zone_a_container_row">
          ...
          while ($needed_loop > 0) {
            ...
            $html .= '<div class="zone_a_vertical zone_a_vertical_'.$needed_loop.'" style="width:auto">';
            ...
            for ( ; $extra_seats > 0; $extra_seats--) {
              $html .= "<div class='z_a_seat zone_a_left' style='height: ". ($height_p_s) ."px '><img src='".$seat_blank."'></div>";
            }
            ...
            for ( ; $z_b_seat_single_count > 0; $z_b_seat_single_count--) {
              ...
              if (count($z_b_seat_single) == 1) {
                ...
                $html .= "<div data-seat_number='{$seat_number}' data-uid='{$uid}' data-price='{$z_b_seating_plan_data_single[1]}' data-name='{$z_b_seating_plan_data_single[0]}' class='z_a_seat zone_a_left {$class_f_a} {$uid}' style='height: ". ($height_p_s) ."px '><img src='".$default_seat_color."'></div>";
              ...
              $html .= "<div data-seat_number='{$seat_number}' data-uid='{$uid}' data-price='{$z_b_seating_plan_data_single[1]}' data-name='{$z_b_seating_plan_data_single[0]}' class='z_a_seat zone_a_left {$class_f_a} {$uid}' style='height: ". ($height_p_s) ."px '><img src='".$z_b_seat_color."'></div>";
